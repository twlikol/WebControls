...
{
    [
    ToolboxData("<{0}:RequiredFieldImageValidator runat=server />")
    ]
    public class RequiredFieldImageValidator : RequiredFieldValidator
    {
        [
        ...
        public RequiredFieldImageValidator()
        {
